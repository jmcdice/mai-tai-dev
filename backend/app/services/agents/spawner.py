...
def get_agent_status(workspace_id: UUID) -> dict:
    ...
    return {
        ...
        # When this process last began, which is not "Created" for a container
        # that has been restarted. The watchdog measures silence from here so a
        # booting agent isn't mistaken for a dead one.
